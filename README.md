...
Dify has no built-in way to manage a *fleet* of workflows: you export apps one at a
time, there's no cross-workflow view of who owns what, and no place to record
keep/delete decisions or environment tags. These are long-standing, still-open
community requests — batch export
([#7966](https://github.com/langgenius/dify/issues/7966),
[#26158](https://github.com/langgenius/dify/issues/26158)), workflow-as-code / CI-CD
promotion ([#32310](https://github.com/langgenius/dify/issues/32310),
[#27685](https://github.com/langgenius/dify/issues/27685)), multi-env tags
([#23639](https://github.com/langgenius/dify/issues/23639)), creator-level ownership
and edit restrictions ([#37154](https://github.com/langgenius/dify/issues/37154)), and
backup/cleanup ([#20645](https://github.com/langgenius/dify/issues/20645),
[#29094](https://github.com/langgenius/dify/discussions/29094)).

**What makes this project different.** Several community CLIs already do bulk
export/backup and Git sync well — e.g.
[dify-dsl-pipe](https://github.com/linhai0872/dify-dsl-pipe),
[difync](https://github.com/pepabo/difync),
[dify-cli](https://github.com/jimx7/dify-cli), and
[DifyAI-mcp](https://github.com/ozanbilgili/DifyAI-mcp). None of them — and neither
Dify itself — offer **governance**: a single dashboard of every workflow with owner,
keep/delete decision, environment tags, notes, and info-completeness, kept in an
**editable shared tracker** (Confluence) that writes back automatically, with Slack
nudges, one-click prune, and author suggestions. Heavyweight enterprise catalogs (SAP
AI Agent Hub, Gravitee AI Catalog, ModelOp) cover governance at the org level but are
vendor-agnostic, paid, and not Dify-native.

**In short:** this is the lightweight, self-hosted *governance layer* that Dify and the
existing export CLIs don't give you. Opportunities on the roadmap where competitors are
ahead: multi-instance dev→prod promotion, Git-backed versioning / DSL diff, and
open-sourcing the governance angle.
...
- **Host networking** is used so the backend can resolve/reach Dify over your
  private network (e.g. Tailscale/NetBird/WireGuard names resolve via the host). This
...
> (e.g. `0 8 * * 1 /path/to/dify-console/run.sh sync`) or a self-hosted runner.
...
guidelines, and [SECURITY.md](SECURITY.md) for reporting vulnerabilities.

## Credits

This project began as a fork of
[sattosan/dify-apps-dsl-exporter](https://github.com/sattosan/dify-apps-dsl-exporter)
(the original bulk export/import CLI) and extends it with the Confluence tracker sync,
Slack notifications, readable Markdown/Confluence docs, and the governance web console.

## License

MIT — see [LICENSE](LICENSE). Original work © 2025 sattosan; additions © 2026 1devspace.
