...
# (e.g. a VPN/overlay network). One transport-level retry masks a brief blip; we
# keep it low because a hung system resolver (getaddrinfo) makes each retry slow,
# and the endpoint already turns a real outage into a clear 503.
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=(
                ...
                f"a transient VPN/DNS blip — check your network/VPN and retry. ({exc})"
            ),
        ) from exc
